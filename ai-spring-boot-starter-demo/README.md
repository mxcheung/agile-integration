====================================
## Agile Integration Spring Boot Demo


java -jar -Dspring.profiles.active=dev -Dcamelsimple.route.path=c://route//dev ai-spring-boot-starter-demo-1.0.0-SNAPSHOT.jar

### What is this repository for? ###

* Service to demo spring boot agile integration
* 1.0.0
