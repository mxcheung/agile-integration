package au.com.mxcheung.starter.swagger;
...
public class SwaggerConfiguration {
     ...
     * Note: forces to pick up endpoints configured with the au.com.mxcheung base package. 
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("au.com.mxcheung"))
                .paths(any())
                .build();
    }
